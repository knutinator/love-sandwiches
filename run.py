...
def validate_data(values):
    ...
    raises ValueError if other than 6 values,
    or if string cannot be converted
    """
    try:
...
def update_worksheet(data, worksheet):
    """
    takes a list of integers and inserts it to the specified worksheet
    """
...
def get_last_5_entries_sales():
    """
    gets the last 5 entries of sales data for each sandwich,
...
def calculate_stock_data(data):
    """
    calculate the avg stock for each item type, add 10%
    """
